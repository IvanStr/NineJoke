namespace NineJoke.Common
{
    public static class GlobalConstants
    {
        ...
        public const string POST_PATH_TEMPLATE = "wwwroot/images/Posts/{0}.jpg";
        public const string POST_SRC_ROOT_TEMPLATE = "/images/Posts/{0}.jpg";
    }
}
